...
public class UserController {
  ...
  @GetMapping("/users-validation/{email}/{password}")
  private UserDto getUserValidation(@PathVariable("email") String email, @PathVariable("password") String password){
      return userService.getUserValidation(email, password);
  }
